...
df = pd.DataFrame({"Current Ranking" : currRank, "Last Week's Ranking" : pastRank, "Song Title" : title, "Artist" : artist, "Peak Position" : peakPosition, "Num Weeks in TOP 100" : top100})

df.to_csv('KPOP Data.csv', sep=',')
